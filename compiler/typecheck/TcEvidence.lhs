...
import Var
import Coercion( Coercion, LeftOrRight(..), pickLR, nthRole, mkUnbranchedAxInstCo, mkSymCo )
import qualified Coercion as C
import PprCore ()   -- Instance OutputableBndr TyVar
import TypeRep  -- Knows type representation
import TcType
import Type( tyConAppArgN, tyConAppTyCon_maybe, getEqPredTys, getEqPredRole, coAxNthLHS, splitTyConApp )
